...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Log in - SitePhotoSharing/input_Email_Input.Password'), 'S9nSJzsI1PKTZXmgCwavJw==')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_AdaugarePoza - SitePhotoSharing/select_Selectati o categorie               _d6b5ab'), 
    '1', true)

WebUI.setText(findTestObject('Object Repository/Page_AdaugarePoza - SitePhotoSharing/input_Descriere_Descriere'), 'Catselus fara parul cret')
...
WebUI.click(findTestObject('Object Repository/Page_Toate Pozele Mele - SitePhotoSharing/a_Sterge'))

WebUI.click(findTestObject('Object Repository/Page_StergerePoza - SitePhotoSharing/input__btn btn-danger'))
